...
- name: touch file zabbix_agentd.conf
  template:
    ...
    mode: 0644
  notify:
    - zabbix-agent.service restarted
...
![img](https://github.com/alzarman/sysmon/blob/main/img/zab1_10.png)

![img](https://github.com/alzarman/sysmon/blob/main/img/zab1_11.png)

![img](https://github.com/alzarman/sysmon/blob/main/img/zab1_12.png)
